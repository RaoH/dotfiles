...
vim.g.opencode_opts = {
	...
	prompts = {
		...
		this = { prompt = "@this" },
		commitmsg = {
			prompt = "@diff Write commit message for the change with commitizen convention. Keep the title under 50 characters and wrap message at 72 characters. Format as a gitcommit code block. Add the files and prompt me for moving on before making a git commit. If on main, create an appropriate feature. ",
			submit = true,
		},
